...
const AboutMeSkills: Array<AboutMeSkill> = [
  {
    skills1: ['HTML', 'CSS', 'SCSS', 'JavaScript', 'TypeScript', 'React', 'Next.js'],
    // skills2: [
    //     'Ruby',
    //     'Ruby on Rails',
    //     'MySQL',
    //     'AWS',
    // ],
    skills3: ['Visual Studio Code', 'Slack', 'Vercel', 'Material UI'],
  },
]
    ...
    return (
      <div className={classes.skills}>
        {AboutMeSkill.skills1.map((skill) => {
          return <Chip key={skill} label={skill} color="primary" variant="outlined" />
        })}
      </div>
    )
  })
